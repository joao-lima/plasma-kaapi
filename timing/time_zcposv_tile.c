...
{
    PLASMA_Complex64_t *A = NULL, *AT, *b = NULL, *bT, *x = NULL, *xT;
    real_Double_t       t;
    ...
    xT = (PLASMA_Complex64_t *)malloc(nt*nb2   *sizeof(PLASMA_Complex64_t));
    ...
    PLASMA_Desc_Create(&descX, xT, PlasmaComplexDouble, nb, nb, nb*nb, n, nrhs, 0, 0, n, nrhs);
