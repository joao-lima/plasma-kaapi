...
{
    PLASMA_Complex64_t *A = NULL, *AT, *b = NULL, *bT, *x, *xT;
    ...
    xT  = (PLASMA_Complex64_t *)malloc(ldb*nrhs*sizeof(PLASMA_Complex64_t));
    ...
    PLASMA_Desc_Create(&descX, xT, PlasmaComplexDouble, nb, nb, nb*nb, ldb, nrhs, 0, 0, n, nrhs);
