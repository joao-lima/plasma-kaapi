                   ...
                   double *Binitnorm, double *Bplasmanorm, double *Blapacknorm )
{
    ...
    *Bplasmanorm = LAPACKE_dlange_work(LAPACK_COL_MAJOR, 'i', M, NRHS, Bplasma, LDB, work);
...
/*     int info_solution; */
    ...
    *xnorm = LAPACKE_dlange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), M, NRHS, X, LDB, work);
    *bnorm = LAPACKE_dlange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, LDB, work);

    cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, M, NRHS, N, (zone), A, LDA, X, LDB, (mzone), B, LDB);

    Rnorm = LAPACKE_dlange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, M, work);
