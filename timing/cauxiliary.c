                   ...
                   float *Binitnorm, float *Bplasmanorm, float *Blapacknorm )
{
    ...
    *Bplasmanorm = LAPACKE_clange_work(LAPACK_COL_MAJOR, 'i', M, NRHS, Bplasma, LDB, work);
...
/*     int info_solution; */
    ...
    *xnorm = LAPACKE_clange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), M, NRHS, X, LDB, work);
    *bnorm = LAPACKE_clange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, LDB, work);

    cblas_cgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, M, NRHS, N, CBLAS_SADDR(zone), A, LDA, X, LDB, CBLAS_SADDR(mzone), B, LDB);

    Rnorm = LAPACKE_clange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, M, work);
