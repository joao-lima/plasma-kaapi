                   ...
                   float *Binitnorm, float *Bplasmanorm, float *Blapacknorm )
{
    ...
    *Bplasmanorm = LAPACKE_slange_work(LAPACK_COL_MAJOR, 'i', M, NRHS, Bplasma, LDB, work);
...
/*     int info_solution; */
    ...
    *xnorm = LAPACKE_slange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), M, NRHS, X, LDB, work);
    *bnorm = LAPACKE_slange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, LDB, work);

    cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, M, NRHS, N, (zone), A, LDA, X, LDB, (mzone), B, LDB);

    Rnorm = LAPACKE_slange_work(LAPACK_COL_MAJOR, lapack_const(PlasmaInfNorm), N, NRHS, B, M, work);
