...
#if 0
static int check_reduction(int, int, int, PLASMA_Complex32_t*, PLASMA_Complex32_t*, int, PLASMA_Complex32_t*, float);
#endif
 ...
 */
#if 0
static int check_reduction(int uplo, int N, int bw, PLASMA_Complex32_t *A1, PLASMA_Complex32_t *A2, int LDA, PLASMA_Complex32_t *Q, float eps )
{
