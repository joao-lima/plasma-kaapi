...
int testing_csyrk(int argc, char **argv)
{
    ...
    */
    ...
    clagsy(&N, &NminusOne, D, C, &LDC, ISEED, WORK, &info);
    free(D); free(WORK);
                          ...
                          PLASMA_Complex32_t beta,  PLASMA_Complex32_t *Cref, PLASMA_Complex32_t *Cplasma, int LDC)
{
    ...
    cblas_csyrk(CblasColMajor, (CBLAS_UPLO)uplo, (CBLAS_TRANSPOSE)trans,
    ...
    printf("============\n");
    printf("Checking the norm of the difference against reference CSYRK \n");
