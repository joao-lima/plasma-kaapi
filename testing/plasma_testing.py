...
for dtype in range(4):
  ...
  test21 = local_popen(f, cmdbase + " GELS"  + " 0 800 400 825 25 810")
  test22 = local_popen(f, cmdbase + " GELS"  + " 1 800 400 825 25 810 4")
  test23 = local_popen(f, cmdbase + " GELS"  + " 0 400 800 825 25 810")
  test24 = local_popen(f, cmdbase + " GELS"  + " 1 400 800 825 25 810 4")
  test25 = local_popen(f, cmdbase + " GESV"  + " 800 825 25 810")
  test27 = local_popen(f, cmdbase + " GESVD" + " 0 825 800 855")
  test26 = local_popen(f, cmdbase + " GESVD" + " 0 800 825 810")
  test28 = local_popen(f, cmdbase + " HEGV"  + " 800 825 810")
  test29 = local_popen(f, cmdbase + " HEEV"  + " 800 825")
  test30 = local_popen(f, cmdbase + " HEGST" + " 800 825 810")
  sys.stdout.flush()
