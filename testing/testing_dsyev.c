...
int testing_dsyev(int argc, char **argv)
{
    ...
    */
    ...
    PLASMA_Alloc_Workspace_dsyev(N, N, &T);
 ...
 */
#if 0
static int check_reduction(int uplo, int N, int bw, double *A1, double *A2, int LDA, double *Q, double eps )
{
    double alpha = 1.0;
    double beta  = 0.0;
