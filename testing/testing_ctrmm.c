                          ...
                          PLASMA_Complex32_t *Bref, PLASMA_Complex32_t *Bplasma, int LDB)
{
    ...
    cblas_ctrmm(CblasColMajor, (CBLAS_SIDE)side, (CBLAS_UPLO)uplo, (CBLAS_TRANSPOSE)trans,
    ...
    printf("============\n");
    printf("Checking the norm of the difference against reference CTRMM \n");
