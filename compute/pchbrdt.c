                          ...
                          PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    if( N <= 0 ) /* this will be removed we don t need it. */
    {
        ...
        TTau = (PLASMA_Complex32_t *) plasma_shared_alloc(plasma, N,   PlasmaComplexFloat);
    ...
    C     = (PLASMA_Complex32_t *) plasma_shared_alloc(plasma, N,   PlasmaComplexFloat);
    S     = (PLASMA_Complex32_t *) plasma_shared_alloc(plasma, N,   PlasmaComplexFloat);
