 ...
 * @ingroup double
 *
 *  PLASMA_dorgqr - Generates an M-by-N matrix Q with orthonormal columns, which is defined as the
 *  first N columns of a product of the elementary reflectors returned by PLASMA_dgeqrf.
 *
 *******************************************************************************
 *
 * @param[in] M
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dorgqr_Tile - Generates an M-by-N matrix Q with orthonormal columns, which is defined as the
 *  first N columns of a product of the elementary reflectors returned by PLASMA_dgeqrf.
 ...
 *
 *  Non-blocking equivalent of PLASMA_dorgqr_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dorgqr_Tile_Async(PLASMA_desc *A, PLASMA_desc *T, PLASMA_desc *Q,
...
*/
    if (plasma->householder == PLASMA_FLAT_HOUSEHOLDER) {
        plasma_dynamic_call_5(plasma_pdorgqr,
            PLASMA_desc, descA,
            PLASMA_desc, descQ,
            PLASMA_desc, descT,
        ...
        plasma_dynamic_call_6(plasma_pdorgqrrh,
            PLASMA_desc, descA,
            PLASMA_desc, descQ,
            PLASMA_desc, descT,
