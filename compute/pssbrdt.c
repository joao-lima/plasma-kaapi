 ...
 **/
void plasma_pssbrdt_quark(PLASMA_enum uplo,
                          ...
                          PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    if( N <= 0 ) /* this will be removed we don t need it. */
    {
        ...
        TTau = (float *) plasma_shared_alloc(plasma, N,   PlasmaRealFloat);
        
        info = LAPACKE_ssytrd_work(LAPACK_COL_MAJOR, lapack_const(uplo), N,
    ...
    C     = (float *) plasma_shared_alloc(plasma, N,   PlasmaRealFloat);
    S     = (float *) plasma_shared_alloc(plasma, N,   PlasmaRealFloat);
