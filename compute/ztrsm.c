 ...
 *
 *  PLASMA_ztrsm_Tile - Computes triangular solve.
 *  Tile equivalent of PLASMA_ztrsm().
 ...
 *
 ******************************************************************************/
int PLASMA_ztrsm_Tile(PLASMA_enum side, PLASMA_enum uplo,
                      PLASMA_enum transA, PLASMA_enum diag,
 ...
 *
 *  PLASMA_ztrsm_Tile_Async - Computes triangular solve.
 *  Non-blocking equivalent of PLASMA_ztrsm_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_ztrsm_Tile_Async(PLASMA_enum side, PLASMA_enum uplo,
                            PLASMA_enum transA, PLASMA_enum diag,
                            PLASMA_Complex64_t alpha, PLASMA_desc *A, PLASMA_desc *B,
