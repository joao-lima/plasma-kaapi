 ...
 *
 ******************************************************************************/
int PLASMA_dplgsy( double bump, int N,
                   double *A, int LDA,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dplgsy_Tile - Generate a random hermitian matrix by tiles.
 *  Tile equivalent of PLASMA_dplgsy().
 ...
 *
 ******************************************************************************/
int PLASMA_dplgsy_Tile( double bump, PLASMA_desc *A,
                        unsigned long long int seed )
{
    plasma_context_t *plasma;
    PLASMA_sequence *sequence = NULL;
 ...
 *
 *  PLASMA_dplgsy_Tile_Async - Generate a random hermitian matrix by tiles.
 *  Non-blocking equivalent of PLASMA_dplgsy_Tile().
                              ...
                              PLASMA_request  *request)
{
    ...
    plasma_parallel_call_5(plasma_pdplgsy,
        double, bump,
        PLASMA_desc,        descA,
        unsigned long long int, seed,
        PLASMA_sequence*,   sequence,
