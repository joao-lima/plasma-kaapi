...
void plasma_pctrsm(plasma_context_t *plasma)
{
    ...
    PLASMA_Complex32_t lalpha;
    PLASMA_Complex32_t minvalpha;
 ...
 **/
void plasma_pctrsm_quark(PLASMA_enum side, PLASMA_enum uplo, PLASMA_enum trans, PLASMA_enum diag,
                         ...
                         PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    PLASMA_Complex32_t zone       = (PLASMA_Complex32_t) 1.0;
    PLASMA_Complex32_t mzone      = (PLASMA_Complex32_t)-1.0;
    PLASMA_Complex32_t minvalpha  = (PLASMA_Complex32_t)-1.0 / alpha;
    PLASMA_Complex32_t lalpha;
