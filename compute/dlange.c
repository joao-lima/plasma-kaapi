 ...
 *
 ******************************************************************************/
double PLASMA_dlange(PLASMA_enum norm, int M, int N,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dlange_Tile - Tile equivalent of PLASMA_dlange().
 ...
 *
 *  PLASMA_dlange_Tile_Async - Non-blocking equivalent of PLASMA_dlange_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dlange_Tile_Async(PLASMA_enum norm, PLASMA_desc *A, double *work, double *value,
