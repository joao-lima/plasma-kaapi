 ...
 *
 * plasma_pcgetmi2 - realises nprob independant transpositions. Each
...
void plasma_pcgetmi2(plasma_context_t *plasma) {
    ...
    work = (PLASMA_Complex32_t*)plasma_private_alloc(plasma, mb*nb, PlasmaComplexFloat);
