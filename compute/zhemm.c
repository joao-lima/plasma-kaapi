 ...
 *
 *  PLASMA_zhemm_Tile - Performs Hermitian matrix multiplication.
 *  Tile equivalent of PLASMA_zhemm().
 ...
 * @sa PLASMA_chemm_Tile
 * @sa PLASMA_dhemm_Tile
 * @sa PLASMA_shemm_Tile
 *
 ******************************************************************************/
int PLASMA_zhemm_Tile(PLASMA_enum side, PLASMA_enum uplo,
 ...
 *
 *  PLASMA_zhemm_Tile_Async - Performs Hermitian matrix multiplication.
 ...
 *
 ******************************************************************************/
int PLASMA_zhemm_Tile_Async(PLASMA_enum side, PLASMA_enum uplo,
                            PLASMA_Complex64_t alpha, PLASMA_desc *A, PLASMA_desc *B,
                            PLASMA_Complex64_t beta,  PLASMA_desc *C,
