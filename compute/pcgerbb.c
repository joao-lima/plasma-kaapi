...
void plasma_pcgerbb(plasma_context_t *plasma)
{
    ...
    if (A.m >= A.n){
       for (k = 0; k < A.nt; k++) {
           ...
           plasma_static_call_4(plasma_pcgeqrf,
           ...
           plasma_static_call_7(plasma_pcunmqr,
           ...
           if (k+1 < A.nt){
              ...
              plasma_static_call_4(plasma_pcgelqf,
              ...
              plasma_static_call_7(plasma_pcunmlq,
 ...
 *  Could be optimized by using the algorithms from Trefethen book
 **/
void plasma_pcgerbb_quark(PLASMA_desc A, PLASMA_desc T,
