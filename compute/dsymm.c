 ...
 *
 ******************************************************************************/
int PLASMA_dsymm(PLASMA_enum side, PLASMA_enum uplo, int M, int N,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dsymm_Tile - Performs symmetric matrix multiplication.
 *  Tile equivalent of PLASMA_dsymm().
 ...
 *
 ******************************************************************************/
int PLASMA_dsymm_Tile(PLASMA_enum side, PLASMA_enum uplo,
 ...
 *
 *  PLASMA_dsymm_Tile_Async - Performs symmetric matrix multiplication.
 *  Non-blocking equivalent of PLASMA_dsymm_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dsymm_Tile_Async(PLASMA_enum side, PLASMA_enum uplo,
                            double alpha, PLASMA_desc *A, PLASMA_desc *B,
                            double beta,  PLASMA_desc *C,
