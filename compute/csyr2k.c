 ...
 *
 *  PLASMA_csyr2k_Tile - Performs symmetric rank k update.
 *  Tile equivalent of PLASMA_csyr2k().
 ...
 *          = PlasmaTrans: A is conjfugate transposed.
 *
 * @param[in] alpha
 *          alpha specifies the scalar alpha.
 *
 ...
 *
 *  PLASMA_csyr2k_Tile_Async - Performs symmetric rank-k update.
 *  Non-blocking equivalent of PLASMA_csyr2k_Tile().
