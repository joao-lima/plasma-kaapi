 ...
 *
 *  PLASMA_chemm_Tile - Performs Hermitian matrix multiplication.
 *  Tile equivalent of PLASMA_chemm().
 ...
 *
 *  PLASMA_chemm_Tile_Async - Performs Hermitian matrix multiplication.
 *  Non-blocking equivalent of PLASMA_chemm_Tile().
