                  ...
                  int *IPIV)
{
    ...
    plasma_dynamic_call_4(plasma_psgetrf_reclap,
        PLASMA_desc, descA,
        int*, IPIV,
 ...
 * @ingroup float_Tile
 *
 *  PLASMA_sgetrf_Tile - Computes the tile LU factorization of a matrix.
 *  Tile equivalent of PLASMA_sgetrf().
 ...
 *
 *  PLASMA_sgetrf_Tile_Async - Computes the tile LU factorization of a matrix.
 *  Non-blocking equivalent of PLASMA_sgetrf_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_sgetrf_Tile_Async(PLASMA_desc *A, int *IPIV,
