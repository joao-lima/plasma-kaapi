 ...
 *
 *  PLASMA_cgetrs_incpiv - Solves a system of linear equations A * X = B, with a general N-by-N matrix A
 *  using the tile LU factorization computed by PLASMA_cgetrf_incpiv.
 *
 *******************************************************************************
 *
 * @param[in] trans
 ...
 *
 * @param[in] A
 *          The tile factors L and U from the factorization, computed by PLASMA_cgetrf_incpiv.
 *
 * @param[in] LDA
 ...
 *
 *  PLASMA_cgetrs_incpiv_Tile - Solves a system of linear equations using previously
 *  computed LU factorization.
 *  Tile equivalent of PLASMA_cgetrs_incpiv().
 ...
 *
 *  PLASMA_cgetrs_incpiv_Tile_Async - Solves a system of linear equations using previously
 *  computed LU factorization.
 *  Non-blocking equivalent of PLASMA_cgetrs_incpiv_Tile().
