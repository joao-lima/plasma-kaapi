 ...
 * @ingroup double
 *
 *  PLASMA_dsygv - Computes all eigenvalues and, optionally,
 ...
 *
 * @param[in, out] descT
 *          On entry, descriptor as return by PLASMA_Alloc_Workspace_dsygv
 ...
 *
 ******************************************************************************/
int PLASMA_dsygv(PLASMA_enum itype, PLASMA_enum jobz, PLASMA_enum uplo, int N,
                 double *A, int LDA,
                 double *B, int LDB,
                 double *W,
                 PLASMA_desc *descT,
 ...
 *
 ******************************************************************************/
int PLASMA_dsygv_Tile(PLASMA_enum itype, PLASMA_enum jobz, PLASMA_enum uplo, 
 ...
 *
 ******************************************************************************/
int PLASMA_dsygv_Tile_Async(PLASMA_enum itype, PLASMA_enum jobz, PLASMA_enum uplo, 
                            PLASMA_desc *A,
                            PLASMA_desc *B,
                            double *W,
                            PLASMA_desc *T,
