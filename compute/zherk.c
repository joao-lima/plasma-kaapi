 ...
 *
 *  PLASMA_zherk_Tile - Performs hermitian rank k update.
 ...
 *
 ******************************************************************************/
int PLASMA_zherk_Tile(PLASMA_enum uplo, PLASMA_enum trans,
 ...
 *
 *  PLASMA_zherk_Tile_Async - Performs Hermitian rank-k update.
 *  Non-blocking equivalent of PLASMA_zherk_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_zherk_Tile_Async(PLASMA_enum uplo, PLASMA_enum trans,
                            double alpha, PLASMA_desc *A,
                            double beta,  PLASMA_desc *C,
