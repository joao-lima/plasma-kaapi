 ...
 * @ingroup double
 *
 *  PLASMA_dposv - Computes the solution to a system of linear equations A * X = B,
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dposv_Tile - Solves a symmetric positive definite or Hermitian positive definite
 *  system of linear equations using the Cholesky factorization.
 *  Tile equivalent of PLASMA_dposv().
 ...
 *
 *  PLASMA_dposv_Tile_Async - Solves a symmetric positive definite or Hermitian
 *  positive definite system of linear equations using the Cholesky factorization.
 *  Non-blocking equivalent of PLASMA_dposv_Tile().
