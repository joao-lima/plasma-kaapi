 ...
 *
 ******************************************************************************/
int PLASMA_cgesvd(PLASMA_enum jobu, PLASMA_enum jobvt, int M, int N,
                  ...
                  PLASMA_desc *descT)
{
    ...
    if ( (plasma_desc_check(descT) != PLASMA_SUCCESS) || 
        ...
        plasma_error("PLASMA_cgesvd", "invalid T descriptor");
        return -12;
    }
    /* Quick return */
    if (min(M, N) == 0) {
    ...
    if (jobu == PlasmaVec) {
        plasma_error("PLASMA_cgesvd", "computing the singular vectors is not supported in this version");
        return -1;
    }
    if (jobvt == PlasmaVec) {
        plasma_error("PLASMA_cgesvd", "computing the singular vectors is not supported in this version");
    ...
    PLASMA_cgesvd_Tile_Async(jobu, jobvt, &descA, S, &descU, &descVT, descT, sequence, &request);
 ...
 *
 ******************************************************************************/
int PLASMA_cgesvd_Tile(PLASMA_enum jobu, PLASMA_enum jobvt, PLASMA_desc *A,
 ...
 *
 ******************************************************************************/
int PLASMA_cgesvd_Tile_Async(PLASMA_enum jobu, PLASMA_enum jobvt, PLASMA_desc *A,
                             float *S, PLASMA_desc *U, PLASMA_desc *VT, PLASMA_desc *T,
