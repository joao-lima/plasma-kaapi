 ...
 * @date 2010-11-15
 * @generated c Thu Sep 15 12:09:22 2011
 *
 **/
#include <stdlib.h>
#include <math.h>
    ...
    case PlasmaMaxNorm:
        ...
        while (n < A.nt) {
            ...
            if (m == n) {
                ...
                ldam = BLKLDD(A, m);
                CORE_clanhe(PlasmaMaxNorm, uplo, X, A(m, n, X1, X1, ldam), ldam, NULL, &normtmp);
            }
            else {
                /*
                 *  PlasmaLower
 ...
 *
 **/
void plasma_pclanhe_quark(PLASMA_enum norm, PLASMA_enum uplo, PLASMA_desc A, float *work, float *result,
