 ...
 *          referenced.
 *          On exit, the lower triangle (if uplo = PlasmaLower)
 ...
 *
 *  PLASMA_zheevd_Tile - Computes all eigenvalues and, optionally,
 *  eigenvectors of a complex Hermitian matrix A using a two-stage
 *  approach:
 *  First stage: reduction to band tridiagonal form;
 *  Second stage: reduction from band to tridiagonal form.
 *
 ...
 *
 *  PLASMA_zheevd_Tile_Async - Computes all eigenvalues and, optionally, eigenvectors of a
 ...
 * @sa PLASMA_dsyevd_Tile_Async
 * @sa PLASMA_ssyevd_Tile_Async
 *
 ******************************************************************************/
