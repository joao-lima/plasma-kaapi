 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dtrmm_Tile - Computes triangular solve.
 *  Tile equivalent of PLASMA_dtrmm().
 ...
 *
 ******************************************************************************/
int PLASMA_dtrmm_Tile(PLASMA_enum side, PLASMA_enum uplo,
                      PLASMA_enum transA, PLASMA_enum diag,
 ...
 *
 *  PLASMA_dtrmm_Tile_Async - Performs triangular matrix multiplication.
 *  Non-blocking equivalent of PLASMA_dtrmm_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dtrmm_Tile_Async(PLASMA_enum side, PLASMA_enum uplo,
                            PLASMA_enum transA, PLASMA_enum diag,
                            double alpha, PLASMA_desc *A, PLASMA_desc *B,
