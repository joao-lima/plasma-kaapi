 ...
 * @ingroup double
 *
 *  PLASMA_dlauum - Computes the product U * U' or L' * L, where the triangular
 ...
 *
 ******************************************************************************/
int PLASMA_dlauum(PLASMA_enum uplo, int N,
                  double *A, int LDA)
{
    int NB;
    int status;
 ...
 *
 *  PLASMA_dlauum_Tile_Async - Computes the product U * U' or L' * L, where the
 *  triangular factor U or L is stored in the upper or lower triangular part of
 *  the array A.
 *  Non-blocking equivalent of PLASMA_dlauum_Tile().
