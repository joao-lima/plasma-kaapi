 ...
 * @ingroup double
 *
 *  PLASMA_dgesv_incpiv - Computes the solution to a system of linear equations A * X = B,
 ...
 *
 ******************************************************************************/
int PLASMA_dgesv_incpiv(int N, int NRHS,
                 double *A, int LDA,
                 double *L, int *IPIV,
                 double *B, int LDB)
{
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dgesv_incpiv_Tile - Solves a system of linear equations using the tile LU factorization.
 ...
 *
 *  PLASMA_dgesv_incpiv_Tile_Async - Solves a system of linear equations using the tile
 *  LU factorization.
 *  Non-blocking equivalent of PLASMA_dgesv_incpiv_Tile().
