 ...
 *******************************************************************************
 *
 * @sa PLASMA_zher2k_Tile
 * @sa PLASMA_cher2k
 * @sa PLASMA_dher2k
 * @sa PLASMA_sher2k
 *
 ******************************************************************************/
int PLASMA_zher2k(PLASMA_enum uplo, PLASMA_enum trans, int N, int K,
 ...
 *
 *  PLASMA_zher2k_Tile - Performs hermitian rank k update.
 *  Tile equivalent of PLASMA_zher2k().
 ...
 *
 ******************************************************************************/
int PLASMA_zher2k_Tile(PLASMA_enum uplo, PLASMA_enum trans,
 ...
 *
 *  PLASMA_zher2k_Tile_Async - Performs Hermitian rank-k update.
 *  Non-blocking equivalent of PLASMA_zher2k_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_zher2k_Tile_Async(PLASMA_enum uplo, PLASMA_enum trans,
                             PLASMA_Complex64_t alpha, PLASMA_desc *A, PLASMA_desc *B,
                             double beta,  PLASMA_desc *C,
