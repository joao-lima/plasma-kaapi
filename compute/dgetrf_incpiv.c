 ...
 * @ingroup double
 *
 *  PLASMA_dgetrf_incpiv - Computes an LU factorization of a general M-by-N matrix A
 ...
 *          required by PLASMA_dgetrs_incpiv to solve the system of equations.
 *
 * @param[out] IPIV
 ...
 *
 ******************************************************************************/
int PLASMA_dgetrf_incpiv(int M, int N,
                  double *A, int LDA,
                  double *L, int *IPIV)
{
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dgetrf_incpiv_Tile - Computes the tile LU factorization of a matrix.
 *  Tile equivalent of PLASMA_dgetrf_incpiv().
 ...
 *
 *  PLASMA_dgetrf_incpiv_Tile_Async - Computes the tile LU factorization of a matrix.
 *  Non-blocking equivalent of PLASMA_dgetrf_incpiv_Tile().
...
*/
    ...
    plasma_parallel_call_5(plasma_pdgetrf_incpiv,
        PLASMA_desc, descA,
        PLASMA_desc, descL,
        int*, IPIV,
