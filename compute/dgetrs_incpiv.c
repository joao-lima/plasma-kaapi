 ...
 * @ingroup double
 *
 *  PLASMA_dgetrs_incpiv - Solves a system of linear equations A * X = B, with a general N-by-N matrix A
 *  using the tile LU factorization computed by PLASMA_dgetrf_incpiv.
 *
 *******************************************************************************
 *
 * @param[in] trans
 ...
 *
 * @param[in] A
 *          The tile factors L and U from the factorization, computed by PLASMA_dgetrf_incpiv.
 *
 * @param[in] LDA
 ...
 *
 ******************************************************************************/
int PLASMA_dgetrs_incpiv(PLASMA_enum trans, int N, int NRHS,
                        double *A, int LDA,
                        double *L, int *IPIV,
                        double *B, int LDB)
{
 ...
 * @ingroup double_Tile
 *
 *  PLASMA_dgetrs_incpiv_Tile - Solves a system of linear equations using previously
 *  computed LU factorization.
 *  Tile equivalent of PLASMA_dgetrs_incpiv().
 ...
 *
 *  PLASMA_dgetrs_incpiv_Tile_Async - Solves a system of linear equations using previously
 *  computed LU factorization.
 *  Non-blocking equivalent of PLASMA_dgetrs_incpiv_Tile().
 ...
 *
 ******************************************************************************/
int PLASMA_dgetrs_incpiv_Tile_Async(PLASMA_desc *A, PLASMA_desc *L, int *IPIV, PLASMA_desc *B,
