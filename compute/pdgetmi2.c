 ...
 *
 * plasma_pdgetmi2 - realises nprob independant transpositions. Each
 ...
 * @ingroup InPlaceTransformation
 *
 * plasma_pdgetmi2_quark - realises nprob independant transpositions. Each
 * subproblem is a tile of mb-by-nb elements.
 ...
 *
 ******************************************************************************/
void plasma_pdgetmi2_quark(PLASMA_enum idep, PLASMA_enum odep, PLASMA_enum storev, 
