...
{
    DAG_CORE_UNMQR;
    QUARK_Insert_Task(quark, CORE_dormqr_quark, task_flags,
        ...
        sizeof(int),                        &k,     VALUE,
        sizeof(int),                        &ib,    VALUE,
        sizeof(double)*nb*nb,    A,             INPUT | QUARK_REGION_L,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_dormqr_quark = PCORE_dormqr_quark
#define CORE_dormqr_quark PCORE_dormqr_quark
#endif
