 ...
 *
 *  CORE_zhblrx is a kernel that will operate on a region (triangle) of data bounded 
 *  by st and ed. This kernel apply a left update, followed by an right 
