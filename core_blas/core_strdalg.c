 ...
 * @ingroup CORE_float
 *
 *  CORE_strdalg is a part of the tridiagonal reduction algorithm (bulgechasing)
...
#pragma weak CORE_strdalg = PCORE_strdalg
#define CORE_strdalg PCORE_strdalg
#endif
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_strdalg_quark = PCORE_strdalg_quark
#define CORE_strdalg_quark PCORE_strdalg_quark
#endif
