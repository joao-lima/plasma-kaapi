...
#pragma weak CORE_ztsqrt = PCORE_ztsqrt
#define CORE_ztsqrt PCORE_ztsqrt
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_ztsqrt_quark = PCORE_ztsqrt_quark
#define CORE_ztsqrt_quark PCORE_ztsqrt_quark
#endif
