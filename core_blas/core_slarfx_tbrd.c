 ...
 *  =======
 *
 *  CORE_slarfx2 applies a complex elementary reflector H to a complex m by n
 ...
 ******************************************************************************/
int 
CORE_slarfx2(PLASMA_enum side, int N,
             float V,
             float TAU,
             float *C1, int LDC1,
             float *C2, int LDC2)
 ...
 *  =======
 *
 *  CORE_slarfx2c applies a complex elementary reflector H to a diagonal corner 
 ...
 ******************************************************************************/
int 
CORE_slarfx2c(PLASMA_enum uplo,
              float V,
              float TAU,
              float *C1,
              float *C2,
 ...
 ******************************************************************************/
int 
CORE_slarfx2ce(PLASMA_enum uplo,
               float *V,
               float *TAU,
               float *C1,
               float *C2,
