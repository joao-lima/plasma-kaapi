 ...
 * @ingroup CORE_float
 *
 *  CORE_sttmqr overwrites the general complex M1-by-N1 tile A1 and
 ...
 *         CORE_STTQRT in the first k rows of its array argument V.
 *
 * @param[in] LDV
...
#pragma weak CORE_sttmqr = PCORE_sttmqr
#define CORE_sttmqr PCORE_sttmqr
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_sttmqr_quark = PCORE_sttmqr_quark
#define CORE_sttmqr_quark PCORE_sttmqr_quark
#endif
