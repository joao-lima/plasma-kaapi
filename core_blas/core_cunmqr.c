 ...
 *
 *  CORE_cunmqr overwrites the general complex M-by-N tile C with
 *
 *                    SIDE = 'L'     SIDE = 'R'
 *    TRANS = 'N':      Q * C          C * Q
 *    TRANS = 'C':      Q**H * C       C * Q**H
 ...
 *    Q = H(1) H(2) . . . H(k)
 *
 *  as returned by CORE_cgeqrt. Q is of order M if SIDE = 'L' and of order N
 *  if SIDE = 'R'.
 *
 *******************************************************************************
 *
...
#pragma weak CORE_cunmqr = PCORE_cunmqr
