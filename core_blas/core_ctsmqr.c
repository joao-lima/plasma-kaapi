...
#pragma weak CORE_ctsmqr = PCORE_ctsmqr
                       ...
                       PLASMA_Complex32_t *T, int ldt)
{
    ...
    DAG_CORE_TSMQR;
    QUARK_Insert_Task(quark, CORE_ctsmqr_quark, task_flags,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_ctsmqr_quark = PCORE_ctsmqr_quark
#define CORE_ctsmqr_quark PCORE_ctsmqr_quark
#endif
