 ...
 * @ingroup CORE_float
 *
 *  CORE_ststrf computes an LU factorization of a complex matrix formed
 ...
 *
 * @param[in] L1
 *         The IB-by-K lower triangular tile as returned by CORE_ststrf.
 *
 * @param[in] LDL1
 *         The leading dimension of the array L1.  LDL1 >= max(1,IB).
 *
 * @param[in] L2
 *         The M2-by-N2 tile as returned by CORE_ststrf.
 *
 * @param[in] LDL2
 *         The leading dimension of the array L2.  LDL2 >= max(1,M2).
 *
 * @param[in] IPIV
 *         as returned by CORE_ststrf.
 *
 *******************************************************************************
 *
 * @return
