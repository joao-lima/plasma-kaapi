 ...
 * @ingroup CORE_double
 *
 *  CORE_dttmqr overwrites the general complex M1-by-N1 tile A1 and
...
#pragma weak CORE_dttmqr = PCORE_dttmqr
#define CORE_dttmqr PCORE_dttmqr
                       ...
                       double *T, int ldt)
{
    ...
    DAG_CORE_TTMQR;
    QUARK_Insert_Task(quark, CORE_dttmqr_quark, task_flags,
        ...
        sizeof(double)*nb*nb,    V,             INPUT|QUARK_REGION_D|QUARK_REGION_U,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_dttmqr_quark = PCORE_dttmqr_quark
#define CORE_dttmqr_quark PCORE_dttmqr_quark
#endif
