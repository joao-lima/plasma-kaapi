 ...
 *
 *  CORE_cttmlq overwrites the general complex M1-by-N1 tile A1 and
 ...
 *         CORE_CTTQRT in the first k rows of its array argument V.
 *
 * @param[in] LDV
...
#pragma weak CORE_cttmlq = PCORE_cttmlq
#define CORE_cttmlq PCORE_cttmlq
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_cttmlq_quark = PCORE_cttmlq_quark
#define CORE_cttmlq_quark PCORE_cttmlq_quark
#endif
void CORE_cttmlq_quark(Quark *quark)
{
    ...
    CORE_cttmlq(side, trans, m1, n1, m2, n2, k, ib, A1, lda1, 
