 ...
 * @ingroup CORE_double
 *
 *  CORE_dbrdalg is a part of the bidiagonal reduction algorithm (bulgechasing).
...
#pragma weak CORE_dbrdalg = PCORE_dbrdalg
#define CORE_dbrdalg PCORE_dbrdalg
#endif
...
{
    QUARK_Insert_Task(quark, CORE_dbrdalg_quark,   task_flags,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_dbrdalg_quark = PCORE_dbrdalg_quark
#define CORE_dbrdalg_quark PCORE_dbrdalg_quark
#endif
