 ...
 * @ingroup CORE_float
 *
 *  CORE_sgeqrt computes a QR factorization of a complex M-by-N tile A:
 *  A = Q * R.
 *
...
#pragma weak CORE_sgeqrt = PCORE_sgeqrt
#define CORE_sgeqrt PCORE_sgeqrt
#endif
                ...
                float *WORK)
{
    ...
    for(i = 0; i < k; i += IB) {
        ...
        iinfo = LAPACKE_sgeqr2_work(LAPACK_COL_MAJOR, M-i, sb, 
