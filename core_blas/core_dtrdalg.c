 ...
 * @ingroup CORE_double
 *
 *  CORE_dtrdalg is a part of the tridiagonal reduction algorithm (bulgechasing)
...
#pragma weak CORE_dtrdalg = PCORE_dtrdalg
#define CORE_dtrdalg PCORE_dtrdalg
#endif
void CORE_dtrdalg(PLASMA_enum uplo, int N, int NB, 
                  PLASMA_desc *pA, double *V, double *TAU,
...
{
    QUARK_Insert_Task(quark, CORE_dtrdalg_quark,   task_flags,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_dtrdalg_quark = PCORE_dtrdalg_quark
#define CORE_dtrdalg_quark PCORE_dtrdalg_quark
#endif
