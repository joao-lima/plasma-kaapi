...
#define CORE_dtsrfb PCORE_dtsrfb
                       ...
                       double *T, int ldt)
{
    ...
    DAG_CORE_TSMQR;
    QUARK_Insert_Task(quark, CORE_dtsmqr_quark, task_flags,
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_dtsmqr_quark = PCORE_dtsmqr_quark
#define CORE_dtsmqr_quark PCORE_dtsmqr_quark
#endif
