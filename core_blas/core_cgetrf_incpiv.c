 ...
 *
 *  CORE_cgetrf_incpiv computes an LU factorization of a general M-by-N tile A
...
#pragma weak CORE_cgetrf_incpiv = PCORE_cgetrf_incpiv
#define CORE_cgetrf_incpiv PCORE_cgetrf_incpiv
                ...
                int *IPIV, int *INFO)
{
    ...
    *INFO = 0;
    ...
    for(i =0 ; i < k; i += IB) {
         ...
         */
        iinfo = LAPACKE_cgetf2_work(LAPACK_COL_MAJOR, M-i, sb, &A[LDA*i+i], LDA, &IPIV[i]);
        /*
