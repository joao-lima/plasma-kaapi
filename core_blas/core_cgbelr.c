 ...
 * @author Azzam Haidar
 * @date 2011-05-15
 * @generated c Thu Sep 15 12:09:02 2011
 *
 **/
#include <lapacke.h>
#include "common.h"
 ...
 *
 *  CORE_cgbelr is a kernel that will operate on a region (triangle) of data bounded 
 ...
 *  update on the diagonal 2x2 element, where it create a new nnz, eliminate it 
 *  and update V and TAU, then it continue until finishing the 
