 ...
 * @ingroup CORE_float
 *
 *  CORE_stsmlq overwrites the general complex M1-by-N1 tile A1 and
...
#pragma weak CORE_stsmlq = PCORE_stsmlq
 ...
 **/
#if defined(PLASMA_HAVE_WEAK)
#pragma weak CORE_stsmlq_quark = PCORE_stsmlq_quark
#define CORE_stsmlq_quark PCORE_stsmlq_quark
#endif
