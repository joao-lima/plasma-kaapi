 ...
 **/
void plasma_pclapack_to_tile_quark(PLASMA_Complex32_t *Af77, int lda, PLASMA_desc A,
 ...
 *  Conversion from LAPACK F77 matrix layout to tile layout - dynamic scheduling
 **/
void plasma_pctile_to_lapack_quark(PLASMA_desc A, PLASMA_Complex32_t *Af77, int lda,
                                   PLASMA_sequence *sequence, PLASMA_request *request)
{
    PLASMA_Complex32_t *f77;
    PLASMA_Complex32_t *bdl;
 ...
 **/
void plasma_pctile_zero_quark(PLASMA_desc A, PLASMA_sequence *sequence, PLASMA_request *request)
{
    PLASMA_Complex32_t *bdl;
    plasma_context_t *plasma;
    int X1, Y1;
