 ...
 **/
void plasma_pdlapack_to_tile_quark(double *Af77, int lda, PLASMA_desc A,
 ...
 **/
void plasma_pdtile_zero_quark(PLASMA_desc A, PLASMA_sequence *sequence, PLASMA_request *request)
{
    double *bdl;
    plasma_context_t *plasma;
    int X1, Y1;
