/**
 *
 * @file example_sgeqrs.c
 *
 *  PLASMA testing routines
 *  PLASMA is a software package provided by Univ. of Tennessee,
 *  Univ. of California Berkeley and Univ. of Colorado Denver
 *
 * @brief Example for solving overdetermined linear systems
 *
 * @version 2.4.2
 * @author Bilel Hadri
 * @date 2010-11-15
...
int main ()
{
    ...
    /* Solve the problem */
    info = PLASMA_sgeqrs(M, N, NRHS, A2, LDA, T, B2, LDB);

    /* Check the solution */
    info_solution = check_solution(M, N, NRHS, A1, LDA, B1, B2, LDB);

    if ((info_solution != 0)|(info != 0))
       printf("-- Error in SGEQRS example ! \n");
    else
       printf("-- Run of SGEQRS example successful ! \n");
