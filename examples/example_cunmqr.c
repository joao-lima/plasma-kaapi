/**
 *
 * @file example_cunmqr.c
 *
 *  PLASMA testing routines
 *  PLASMA is a software package provided by Univ. of Tennessee,
 *  Univ. of California Berkeley and Univ. of Colorado Denver
 *
 * @brief Example for solving overdetermined linear systems with PLASMA_cunmqr
 *
 * @version 2.4.2
 * @author Bilel Hadri
 * @date 2010-11-15
...
int main ()
{
    ...
    /* Solve the problem */
    info = PLASMA_cunmqr(PlasmaLeft, PlasmaConjTrans, M, NRHS, N, A2, LDA, T, B2, LDB);
    ...
    if ((info_solution != 0)|(info != 0))
       printf("-- Error in CUNMQR example ! \n");
    else
       printf("-- Run of CUNMQR example successful ! \n");
