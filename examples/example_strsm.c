 ...
 *        Cholesky factorization and PLASMA_strsm routine
 *
 * @version 2.4.2
 * @author Bilel Hadri
 * @date 2010-11-15
...
int main ()
{
    ...
    /* PLASMA routines */
    info = PLASMA_spotrf(PlasmaLower, N, A2, LDA);
    info = PLASMA_strsm(PlasmaLeft, PlasmaLower, PlasmaNoTrans, PlasmaNonUnit, 
                        N, NRHS, (float)1.0, A2, LDA, B2, LDB);
    info = PLASMA_strsm(PlasmaLeft, PlasmaLower, PlasmaTrans, PlasmaNonUnit,
                        N, NRHS, (float)1.0, A2, LDA, B2, LDB);
